...
describe("UI Object Base Description", function () {
    ...
    describe("Constructor", function () {
        it("should assign 'Standard Windows' and LeanFT type", function () {
    ...
    describe("accessibleName method", function () {
        it("should add 'acc_name' to _properties when value is given", function () {
            uiObjectBaseDescriptionUnderTest.accessibleName("accessibleName");
            assert.strictEqual(uiObjectBaseDescriptionUnderTest._properties["acc_name"], "accessibleName");
        });

        it("should return this - builder pattern when value is given", function () {
            var result = uiObjectBaseDescriptionUnderTest.accessibleName("accessibleName");
            assert.strictEqual(result, uiObjectBaseDescriptionUnderTest);
        });

        it("should remove 'acc_name' from _properties when value is null", function () {
            uiObjectBaseDescriptionUnderTest._properties["acc_name"] = "accessibleName";
            uiObjectBaseDescriptionUnderTest.accessibleName(null);
            assert(!("acc_name" in uiObjectBaseDescriptionUnderTest._properties));
        });

        it("should return the value of 'acc_name' from _properties when value is not given", function () {
            uiObjectBaseDescriptionUnderTest._properties["acc_name"] = "accessibleName";
            var result = uiObjectBaseDescriptionUnderTest.accessibleName();
            assert.equal(result, "accessibleName");
        });
    });
...
describe("UI Object Base Test Object", function () {
    ...
    describe("accessibleName method", function () {
        it("should execute _getROProperty 'acc_name'", function () {
            uiObjectBaseTOUnderTest.accessibleName();
            sinon.assert.calledOnce(uiObjectBaseTOUnderTest._getROProperty);
            sinon.assert.calledWith(uiObjectBaseTOUnderTest._getROProperty, "acc_name", sinon.match({}));
        });

        it("should return promise as is", function () {
            var promiseMock = {};
            uiObjectBaseTOUnderTest._getROProperty.returns(promiseMock);
            var res = uiObjectBaseTOUnderTest.accessibleName();
