...
var PowerBuilderFactory = require("../lib/powerbuilder_factory.js").PowerBuilderFactory;


describe("PowerBuilderFactory", function () {
    var pbFactoryUnderTest;
    var sessionMock;
    ...
    beforeEach(function () {
        ...
        pbFactoryUnderTest = new PowerBuilderFactory({});
    });
    ...
    describe("all test objects tests", function () {
        it("should have waitUntilEnabled function if they have isEnabled function", function () {
            Object.keys(pbFactoryUnderTest._constructors).forEach(function(type) {
                var constructor =  pbFactoryUnderTest._constructors[type];
