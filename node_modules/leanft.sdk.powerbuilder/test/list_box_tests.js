...
describe("List Box Test Object", function () {
    ...
    var ListItem = require("leanft.sdk.stdwin").Behaviors.ListItem;
    ...
    // describe("_isItemAnchor method", function () {
    //     it("should return the execution promise", function () {
    //         var executionPromise = {};
    //         listBoxTOUnderTest._executeNotWrapped.returns(executionPromise);
    //         var res = listBoxTOUnderTest._isItemAnchor(10);
    //         assert.equal(res, executionPromise);
    //     });
    //
    //     it("should execute _executeNotWrapped 'GetItemProperty' with correct parameters, if input is bool", function () {
    //         listBoxTOUnderTest._isItemAnchor(10);
    //         sinon.assert.calledOnce(listBoxTOUnderTest._executeNotWrapped);
    //         sinon.assert.calledWith(listBoxTOUnderTest._executeNotWrapped, sinon.match({ 0: 10 }), "GetItemProperty", 10, "IsAnchor");
    //     });
    //
    //     it("should execute _executeNotWrapped 'GetItemProperty' with correct parameters, if input is string", function () {
    //         listBoxTOUnderTest._isItemAnchor("Item1");
    //         sinon.assert.calledOnce(listBoxTOUnderTest._executeNotWrapped);
    //         sinon.assert.calledWith(listBoxTOUnderTest._executeNotWrapped, sinon.match({ 0: "Item1" }), "GetItemProperty", "Item1", "IsAnchor");
    //     });
    // });
