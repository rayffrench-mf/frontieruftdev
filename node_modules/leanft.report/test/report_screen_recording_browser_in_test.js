...
xdescribe("new Test", function () {
    ...
    it("Test screen recording start/stop in test", function (done) {
    ...
    it("2nd test screen recording start/stop in test", function (done) {
        
        LFT.Reporter.startScreenRecording("test2-video.avi").then(function () {
            Web.Browser.launch(browserTypeToTest).then(function (b) {
                browser = b;
                browser.navigate("http://demo.borland.com").then(function (res){});
            }).then(function() {
